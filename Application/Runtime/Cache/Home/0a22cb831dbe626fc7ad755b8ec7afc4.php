...
<body>
	...
	<h4>最近一次登录时间<?php echo ($login_time); ?></h4>
  	<div id="content">
	...
	<br/>
	<fieldset>
      <a href="https://localhost/single_love/index.php/Home/Email/Email/index/user_id/<?php echo ($photo['members_id']); ?>"><button type="button"><h3>发信</h3></button></a>
    	 <a href="https://localhost/single_love/index.php/Home/Look/Followers/index/user_id/<?php echo ($photo['members_id']); ?>"><button type="button"><h3>加关注</h3></button></a>
		<a href="https://localhost/single_love/index.php/Home/Gift/Gift/index/userid/<?php echo ($photo['members_id']); ?>"><button type="button"><h3>送礼物</h3></button></a>
		<a href="#"><button type="button"><h3>邀请参加活动</h3></button></a>  
	</fieldset>
	<br>
