...
<tr class = "success">
<td>
<?php $__FOR_START_2035116886__=0;$__FOR_END_2035116886__=$about['num'];for($i=$__FOR_START_2035116886__;$i < $__FOR_END_2035116886__;$i+=1){ ?><div class = "row"> 
<div class="col-md-2">
...
<?php if($about['about'][$i]['pic1']): ?><div class="col-md-4">
...
<?php if($about['about'][$i]['pic2']): ?><div class="col-md-4">
...
<?php if($about['about'][$i]['pic3']): ?><div class="col-md-4">
