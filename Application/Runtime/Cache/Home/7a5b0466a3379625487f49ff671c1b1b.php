								...
								<tr class = "success">
									<td>
										...
										<div class = "row">
											...
											<div class="col-md-11">
												<a href="#"><button type="button" class="btn btn-primary btn-lg btn-block">更改头像</button></a>
											</div>
										</div>
										<div class = "row">
 										 	<div class="col-md-0.5"></div>
										 	<div class="col-md-11">
 												<a href="https://localhost/single_love/index.php/Home/Email/Lookemail/index">
													<button class="btn btn-primary btn-lg btn-block" type="button">收件箱 <span class="badge"><?php echo ($count); ?></span></button>
												</a>
      	              </div>
 		                </div>
										<div class = "row">
 											<div class="col-md-0.5"></div>
 												<div class="col-md-11">
 													<a href="https://localhost/single_love/index.php/Home/Look/Look/index">
 														<button class="btn btn-primary btn-lg btn-block" type="button">谁看过我<span class="badge"><?php echo ($look_count); ?></span></button>
 												</a>
 											</div>
										</div>
									</td>
