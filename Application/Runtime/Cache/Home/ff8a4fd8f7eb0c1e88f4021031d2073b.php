...
<div class = "row">
<div class = "col-md-7">
<img src="/single_love/Application/Home/View/Personal/Personal/mode/login.jpg" alt="..." class="img-rounded"  width="100%" height="600"/>
</div>
...
<div class="form-group">
 <div class="col-md-1"></div>
   <label for="inputPassword3" class="col-md-1 control-label"></label>
	...
	<div class="col-md-4">
	<a class="btn btn-sucess" href = "https://localhost/single_love/index.php/Home/Login/Login/index"> 
	<img src="<?php echo u('Home/Login/Test/verify_c');?>" width="100%" height="50"></a>
	</div>
 </div>
-->
  <div class="form-group">
