...
<?php $__FOR_START_1368366467__=0;$__FOR_END_1368366467__=$goods['count'];for($i=$__FOR_START_1368366467__;$i < $__FOR_END_1368366467__;$i+=1){ ?><div class="row">
<div class="col-md-12">
&nbsp;
</div>
</div>
...
<?php if($goods['var'][$i]['author'] != NULL): ?>作者:<?php echo ($goods['var'][$i]['author']); endif; ?>
</div>
...
<div class="col-md-4 text-center">
<?php if($goods['var'][$i]['press'] != NULL): ?>出版社:<?php echo ($goods['var'][$i]['press']); endif; ?>
</div>
<div class="col-md-2 text-center">
...
<?php if($goods['var'][++$i]['pic1'] != NULL): ?><div class="row">
<div class="col-md-2">
<div class="row">
<div class="col-md-12">
<img src="<?php echo ($goods['var'][$i]['pic1']); ?>"  alt = "<?php echo ($goods['var'][$i]['bookname']); ?>dddd" class="img-rounded"  width="100%" height="150"/></a>
