...
<body>
	...
	<fieldset>
 		<h2>谁看过我</h2>
		<?php $__FOR_START_772630285__=0;$__FOR_END_772630285__=$count;for($i=$__FOR_START_772630285__;$i < $__FOR_END_772630285__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>我浏览过的人</h2>
		 <?php $__FOR_START_1141623419__=0;$__FOR_END_1141623419__=$read['count'];for($i=$__FOR_START_1141623419__;$i < $__FOR_END_1141623419__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>谁关注我</h2>
		<?php $__FOR_START_717441161__=0;$__FOR_END_717441161__=$send['count'];for($i=$__FOR_START_717441161__;$i < $__FOR_END_717441161__;$i+=1){ ?><fieldset>
