...
<body>
	...
	<fieldset>
		...
		<?php $__FOR_START_2081501112__=0;$__FOR_END_2081501112__=$count;for($i=$__FOR_START_2081501112__;$i < $__FOR_END_2081501112__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>我浏览过的人</h2>
		你浏览了以下的<?php echo ($Seenuser); ?>会员
		<?php $__FOR_START_1307082365__=0;$__FOR_END_1307082365__=$Seenuser;for($i=$__FOR_START_1307082365__;$i < $__FOR_END_1307082365__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>谁关注我</h2>
		<?php $__FOR_START_78311792__=0;$__FOR_END_78311792__=$send['count'];for($i=$__FOR_START_78311792__;$i < $__FOR_END_78311792__;$i+=1){ ?><fieldset>
