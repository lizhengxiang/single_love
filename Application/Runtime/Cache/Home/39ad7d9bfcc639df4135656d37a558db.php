...
<body>
	...
	<fieldset>
		...
		<?php $__FOR_START_1157571306__=0;$__FOR_END_1157571306__=$count['count'];for($i=$__FOR_START_1157571306__;$i < $__FOR_END_1157571306__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>收件箱(已读):(<?php echo ($read['count']); ?>)</h2>
		 <?php $__FOR_START_227156430__=0;$__FOR_END_227156430__=$read['count'];for($i=$__FOR_START_227156430__;$i < $__FOR_END_227156430__;$i+=1){ ?><fieldset>
	...
	<fieldset>
		...
		<?php $__FOR_START_1199163776__=0;$__FOR_END_1199163776__=$send['count'];for($i=$__FOR_START_1199163776__;$i < $__FOR_END_1199163776__;$i+=1){ ?><fieldset>
