...
<body>
	...
	<fieldset>
		...
		<?php $__FOR_START_1338821107__=0;$__FOR_END_1338821107__=$count['count'];for($i=$__FOR_START_1338821107__;$i < $__FOR_END_1338821107__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>收件箱(已读):(<?php echo ($read['count']); ?>)</h2>
		 <?php $__FOR_START_919500929__=0;$__FOR_END_919500929__=$read['count'];for($i=$__FOR_START_919500929__;$i < $__FOR_END_919500929__;$i+=1){ ?><fieldset>
	...
	<fieldset>
		...
		<?php $__FOR_START_1325087382__=0;$__FOR_END_1325087382__=$send['count'];for($i=$__FOR_START_1325087382__;$i < $__FOR_END_1325087382__;$i+=1){ ?><fieldset>
