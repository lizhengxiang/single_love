...
<body>
	...
	<fieldset>
		...
		<?php $__FOR_START_1730845228__=0;$__FOR_END_1730845228__=$count['count'];for($i=$__FOR_START_1730845228__;$i < $__FOR_END_1730845228__;$i+=1){ ?><fieldset>
	...
	<fieldset>
    	<h2>收件箱(已读):(<?php echo ($read['count']); ?>)</h2>
		 <?php $__FOR_START_889601369__=0;$__FOR_END_889601369__=$read['count'];for($i=$__FOR_START_889601369__;$i < $__FOR_END_889601369__;$i+=1){ ?><fieldset>
	...
	<fieldset>
		...
		<?php $__FOR_START_1117193090__=0;$__FOR_END_1117193090__=$send['count'];for($i=$__FOR_START_1117193090__;$i < $__FOR_END_1117193090__;$i+=1){ ?><fieldset>
