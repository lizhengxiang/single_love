          ...
          <div class="form-group">
			...
			<div class="col-md-12">
						<table class="table table-bordered">
							<tr>
								<td>
										<?php $__FOR_START_576358370__=0;$__FOR_END_576358370__=$countGift;for($i=$__FOR_START_576358370__;$i < $__FOR_END_576358370__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
							...
							<tr class = "success">
								<td>
									<div class="row">
										...
										<?php $__FOR_START_1980913291__=0;$__FOR_END_1980913291__=$usercount;for($i=$__FOR_START_1980913291__;$i < $__FOR_END_1980913291__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
