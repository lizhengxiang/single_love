          ...
          <div class="form-group">
			...
			<div class="col-md-12">
						<table class="table table-bordered">
							<tr>
								<td>
										<?php $__FOR_START_1915808374__=0;$__FOR_END_1915808374__=$countGift;for($i=$__FOR_START_1915808374__;$i < $__FOR_END_1915808374__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
							...
							<tr class = "success">
								<td>
									<div class="row">
										...
										<?php $__FOR_START_398357223__=0;$__FOR_END_398357223__=$usercount;for($i=$__FOR_START_398357223__;$i < $__FOR_END_398357223__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
