          ...
          <div class="form-group">
			...
			<div class="col-md-12">
						<table class="table table-bordered">
							<tr>
								<td>
										<?php $__FOR_START_191025003__=0;$__FOR_END_191025003__=$countGift;for($i=$__FOR_START_191025003__;$i < $__FOR_END_191025003__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
							...
							<tr class = "success">
								<td>
									<div class="row">
										...
										<?php $__FOR_START_966817037__=0;$__FOR_END_966817037__=$usercount;for($i=$__FOR_START_966817037__;$i < $__FOR_END_966817037__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
