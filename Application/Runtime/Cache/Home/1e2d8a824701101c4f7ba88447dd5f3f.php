          ...
          <div class="form-group">
			...
			<div class="col-md-12">
						<table class="table table-bordered">
							<tr>
								<td>
										<?php $__FOR_START_1443393239__=0;$__FOR_END_1443393239__=$countGift;for($i=$__FOR_START_1443393239__;$i < $__FOR_END_1443393239__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
							...
							<tr class = "success">
								<td>
									<div class="row">
										...
										<?php $__FOR_START_958333626__=0;$__FOR_END_958333626__=$usercount;for($i=$__FOR_START_958333626__;$i < $__FOR_END_958333626__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
