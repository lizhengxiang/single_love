          ...
          <div class="form-group">
			...
			<div class="col-md-12">
						<table class="table table-bordered">
							<tr>
								<td>
										<?php $__FOR_START_1390746390__=0;$__FOR_END_1390746390__=$countGift;for($i=$__FOR_START_1390746390__;$i < $__FOR_END_1390746390__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
							...
							<tr class = "success">
								<td>
									<div class="row">
										...
										<?php $__FOR_START_955119120__=0;$__FOR_END_955119120__=$usercount;for($i=$__FOR_START_955119120__;$i < $__FOR_END_955119120__;$i+=1){ ?><div class="row">
												<div class="col-md-1"></div>
