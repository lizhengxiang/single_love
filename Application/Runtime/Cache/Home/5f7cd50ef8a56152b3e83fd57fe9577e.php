...
<body>
	...
	<fieldset>
 		<h2>赠送礼物</h2>
		<?php $__FOR_START_1334975859__=0;$__FOR_END_1334975859__=$count;for($i=$__FOR_START_1334975859__;$i < $__FOR_END_1334975859__;$i+=1){ ?><img src="<?php echo ($gift[$i]['road']); ?>" height="100" width="125"/>
