...
<?php $__FOR_START_302801579__=1;$__FOR_END_302801579__=5;for($i=$__FOR_START_302801579__;$i < $__FOR_END_302801579__;$i+=1){ ?><option><?php echo ($i); ?></option><?php } ?>
</select>
</div>
</div>
...
<?php $__FOR_START_1657964200__=1;$__FOR_END_1657964200__=50;for($i=$__FOR_START_1657964200__;$i < $__FOR_END_1657964200__;$i+=1){ ?><option><?php echo ($i); ?></option><?php } ?>
</select>
</div>
</div>
