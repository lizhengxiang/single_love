...
<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">举报(未处理)</a></li>
<li role="presentation" ><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">已处理举报</a></li>
</ul>
...
<div class="col-md-12">
<!--未读收件箱内容-->
<?php $__FOR_START_1593980759__=0;$__FOR_END_1593980759__=$count['count'];for($i=$__FOR_START_1593980759__;$i < $__FOR_END_1593980759__;$i+=1){ ?><div class="row">
<div class="col-md-3">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<a class="btn btn-info" href="https://localhost/single_love/index.php/Home/Email/reademail/index/userid/<?php echo ($count["email"][$i]["members_id_a"]); ?>/id/<?php echo ($count["email"][$i]["id"]); ?>" role="button">确认已处理</a>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
<div class="col-md-12"> 
<?php $__FOR_START_1219049134__=0;$__FOR_END_1219049134__=$read['count'];for($i=$__FOR_START_1219049134__;$i < $__FOR_END_1219049134__;$i+=1){ ?><div class="row">
<div class="col-md-3">
